...
AGENTS·CLAUDE·path-scoped Rule·수동 PR Skill이 각각 어떤 문제를 다루는지 확인하고, 업무요청 제목 검증과 tenant 격리를 TDD로 구현합니다.
...
6. PR 템플릿에 Red/Green 명령과 남은 위험을 기록합니다.
...
| `.claude/skills/create-pr` | 수동 PR 준비 절차     | 자동 push·자동 merge     |
